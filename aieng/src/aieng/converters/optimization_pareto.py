...
def _build_pareto_front_document(
    ...
    *,
    ...
    doc: dict[str, Any] = {
        ...
        "schema_version": "0.1",
        "status": pareto_result.get("status", "ok"),
        ...
        "front_candidate_ids": pareto_result.get("front_candidate_ids", []),
        "dominated": pareto_result.get("dominated", []),
        "dominated_candidate_ids": pareto_result.get("dominated_candidate_ids", []),
