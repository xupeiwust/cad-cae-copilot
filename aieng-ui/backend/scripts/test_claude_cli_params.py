...
SCENARIOS: list[dict[str, Any]] = [
    {
        "name": "A_base_current",
        "desc": "Current engine params (no session)",
        "cmd": [
            "claude",
            "-p",
            "--bare",
    ...
    {
        "name": "B_with_session_id",
        "desc": "With --session-id (persistence enabled)",
        "cmd": [
            "claude",
            "-p",
            "--bare",
    ...
    {
        "name": "C_with_continue",
        "desc": "With --continue (reuse last session)",
        "cmd": [
            "claude",
            "-p",
            "--bare",
    ...
    {
        "name": "D_permission_auto",
        "desc": "--permission-mode auto (instead of dontAsk)",
        "cmd": [
            "claude",
            "-p",
            "--bare",
    ...
    {
        "name": "F_with_no_session_persistence",
        "desc": "Old param (WITH --no-session-persistence) for comparison",
        "cmd": [
            "claude",
            "-p",
            "--bare",
