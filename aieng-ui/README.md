...
plus post-optimization verification diagnostics only. The verifier checks that
reference/frozen parts were not modified, preserve interfaces remain traceable
or are warned honestly, and proxy limitations stay explicit. It does not certify
