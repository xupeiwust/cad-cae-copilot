...
export const api = {
  ...
  getValueDemoCheck: (projectId: string, signal?: AbortSignal) =>
    request<ValueDemoCheckResponse>(`/api/projects/${projectId}/value-demo-check`, { signal }),
  ...
  getToleranceStackupReport: (projectId: string, signal?: AbortSignal) =>
    request<ToleranceStackupReportResponse>(`/api/projects/${projectId}/tolerance-stackup-report`, { signal }),
